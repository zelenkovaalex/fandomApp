...
class FandomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fandom" do
    assert_difference("Fandom.count") do
      post fandoms_url, params: { fandom: { description: @fandom.description, name: @fandom.name } }
    end
  ...
  test "should update fandom" do
    patch fandom_url(@fandom), params: { fandom: { description: @fandom.description, name: @fandom.name } }
